...
- Перед сдачей прочитать текст как речь на рабочей встрече. Искусственные
  метафоры заменить конкретным деловым смыслом: `самая частая жалоба`, участок
  работы, правила, результат или последствие. Метафора допустима только если
  привычна аудитории и не требует расшифровки.
- Для каждой статьи провести отдельный QA по приемам живой подачи, вдохновленным
  публичной подачей Татьяны Мужицкой: бытовая сцена, простая психология, короткие
  реплики, мягкая самоирония там, где она естественна, и объяснение сложного через
  обычную рабочую ситуацию. В QA записать примененные приемы и исправленные места;
  неподходящий прием отметить `not applicable` с причиной.
- Не имитировать и не копировать авторский голос Татьяны Мужицкой, узнаваемые
  фразы, личные истории или ритм конкретных текстов.
